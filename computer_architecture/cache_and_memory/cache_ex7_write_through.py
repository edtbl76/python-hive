...
#
# ISA memory: Cache
# sb r0 r1 - Cache write: MISS - Main Memory write:  T
# sb r0 r1 - Cache write: MISS - Main Memory write:  h
# sb r0 r1 - Cache write: MISS - Main Memory write:  i
# sb r0 r1 - Cache write: MISS - Main Memory write:  s
# sb r0 r1 - Cache write: MISS - Main Memory write:
# sb r0 r1 - Cache write: MISS - Main Memory write:  M
# sb r0 r1 - Cache write: MISS - Main Memory write:  p
# sb r0 r1 - Cache write: MISS - Main Memory write:  .
...
# EXECUTION TIME: 535.20 nanoseconds
